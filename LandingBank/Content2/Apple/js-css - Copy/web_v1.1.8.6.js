    ...
    return i == "" ? (postValue = $(t).serializeObject(),
        $.post("/api/warranty", postValue, function (n) {
            n.type ? location.href = n.url : n.ok ? ($.toast({
                ...
                $(".container1 .title").text(n.title),
                $(".container1 .imei").text(n.imei),
                $(".container1 .buyDate").text(n.buyDate),
                $(".container1 .expiryDate").text(n.expiryDate),
                $(".container1 .store").text(n.store),
                $(".container1 .found").show(),
                $(".container1 .not-found").hide()) : ($.toast({
                    text: "Không tìm thấy thông tin bảo hành.",
                    showHideTransition: "fade",
                    hideAfter: 5e3
                }),
                    $(".container1 .imei").text(postValue.IMEI),
                    $(".container1 .found").hide(),
                    $(".container1 .not-found").show())
        })) : $.toast({
...
function validFormQuickOrder_v2(n) {
    ...
    return u == null || u == "" ? (t += "Bạn cần tích chọn xác thực không phải người máy.",
        $("#g_captcha_container1").css("border", "1px solid red")) : $("#g_captcha_container1").css("border", "none"),
...
function replyCommentReview() {
    $(".replyReviewHolder input").focus(function () {
        ...
        n = $(this).parent().parent().find(".form-container1");
        $(n).html(t);
...
"function" != typeof Object.create && (Object.create = function (n) {
    ...
    function (n, t) {
        ...
        var i = {
            ...
            position: function () {
                "string" == typeof this.options.position && -1 !== n.inArray(this.options.position, this._positionClasses) ? "bottom-center" === this.options.position ? this._container1.css({
                    left: n(t).outerWidth() / 2 - this._container1.outerWidth() / 2,
                    bottom: 20
                }) : "top-center" === this.options.position ? this._container1.css({
                    left: n(t).outerWidth() / 2 - this._container1.outerWidth() / 2,
                    top: 20
                }) : "mid-center" === this.options.position ? this._container1.css({
                    left: n(t).outerWidth() / 2 - this._container1.outerWidth() / 2,
                    top: n(t).outerHeight() / 2 - this._container1.outerHeight() / 2
                }) : this._container1.addClass(this.options.position) : "object" == typeof this.options.position ? this._container1.css({
                    top: this.options.position.top ? this.options.position.top : "auto",
                    bottom: this.options.position.bottom ? this.options.position.bottom : "auto",
                    left: this.options.position.left ? this.options.position.left : "auto",
                    right: this.options.position.right ? this.options.position.right : "auto"
                }) : this._container1.addClass("bottom-left")
            },
            bindToast: function () {
                var n = this;
...
!function (n, t, i) {
    ...
    if (n.console = n.console || {
        ...
        var l = {
            ...
            slideClass: "",
            baseClass: "",
            baseTpl: '<div class="fancybox-container1" role="dialog" tabindex="-1"><div class="fancybox-bg"><\/div><div class="fancybox-inner"><div class="fancybox-infobar"><span data-fancybox-index><\/span>&nbsp;/&nbsp;<span data-fancybox-count><\/span><\/div><div class="fancybox-toolbar">{{buttons}}<\/div><div class="fancybox-navigation">{{arrows}}<\/div><div class="fancybox-stage"><\/div><div class="fancybox-caption"><div class="fancybox-caption__body"><\/div><\/div><\/div><\/div>',
            ...
            , p = function (n) {
                var r, u;
                return !(!n || n.ownerDocument !== t) && (i(".fancybox-container1").css("pointer-events", "none"),
                    r = {
                    ...
                    i(".fancybox-container1").css("pointer-events", ""),
                    u)
            }
            , h = function (n, t, r) {
                var u = this;
        ...
        i.extend(h.prototype, {
            init: function () {
                ...
                f = i(r.translate(r, u.baseTpl.replace("{{buttons}}", e).replace("{{arrows}}", u.btnTpl.arrowLeft + u.btnTpl.arrowRight))).attr("id", "fancybox-container1-" + r.id).addClass(u.baseClass).data("FancyBox", r).appendTo(u.parentEl);
                r.$refs = {
                    container1: f
                };
            ...
            addEvents: function () {
                var t = this;
                t.removeEvents();
                t.$refs.container1.on("click.fb-close", "[data-fancybox-close]", function (n) {
                    n.stopPropagation();
                    n.preventDefault();
                    t.close(n)
            ...
            removeEvents: function () {
                ...
                this.$refs.container1.off(".fb-close .fb-prev .fb-next");
            ...
            jumpTo: function (n, t) {
                ...
                if (!(r.isDragging || r.isClosing || r.isAnimating && r.firstRun)) {
                    ...
                    if (s = r.firstRun = !Object.keys(r.slides).length,
                        ...
                        s)
                        return f.opts.animationEffect && t && r.$refs.container1.css("transition-duration", t + "ms"),
                            r.$refs.container1.addClass("fancybox-is-open").trigger("focus"),
                            r.loadSlide(f),
            ...
            updateCursor: function (n, t) {
                var o, e, u = this, r = u.current, f = u.$refs.container1;
            ...
            focus: function (n, r) {
                ...
                f.isClosing || (u = !n && f.current && f.current.isComplete ? f.current.$slide.find("*:visible" + (r ? ":not(.fancybox-close-small)" : "")) : f.$refs.container1.find("*:visible"),
                    ...
                    u.length ? (e = u.index(t.activeElement),
                        n && n.shiftKey ? (e < 0 || 0 == e) && (n.preventDefault(),
                            u.eq(u.length - 1).trigger("focus")) : (e < 0 || e == u.length - 1) && (n && n.preventDefault(),
                                u.eq(0).trigger("focus"))) : f.$refs.container1.trigger("focus"))
            },
            activate: function () {
                var n = this;
                i(".fancybox-container1").each(function () {
                ...
                return !r.isClosing && (r.isClosing = !0,
                    !1 === r.trigger("beforeClose", n) ? (r.isClosing = !1,
                        ...
                        !1) : (r.removeEvents(),
                            ...
                            s && r.$refs.container1.removeClass("fancybox-is-open").addClass("fancybox-is-closing").css("transition-duration", s + "ms"),
                            r.hideLoading(f),
                            r.hideControls(!0),
                            r.updateCursor(),
            ...
            cleanUp: function (t) {
                ...
                r.$refs.container1.empty().remove();
            ...
            trigger: function (n, t) {
                ...
                if (u ? f.unshift(u) : u = e,
                    ...
                    !1 === o)
                    return o;
                "afterClose" !== n && e.$refs ? e.$refs.container1.trigger(n + ".fb", f) : r.trigger(n + ".fb", f)
            },
            updateControls: function () {
                ...
                i(t.activeElement).is(":hidden,[disabled]") && n.$refs.container1.trigger("focus")
            },
            hideControls: function (n) {
                var i = this
                    , t = ["infobar", "toolbar", "nav"];
                !n && i.current.opts.preventCaptionOverlap || t.push("caption");
                this.$refs.container1.removeClass(t.map(function (n) {
        ...
        i.fancybox = {
            ...
            getInstance: function (n) {
                var t = i('.fancybox-container1:not(".fancybox-is-closing"):last').data("FancyBox")
    ...
    function (n, t, i) {
        ...
        var o = function () {
            ...
            , r = function (n) {
                ...
                t.$container1 = n.$refs.container1;
                t.destroy();
                t.$container1.on("touchstart.fb.touch mousedown.fb.touch", i.proxy(t, "ontouchstart"))
            };
        r.prototype.destroy = function () {
            var n = this;
            n.$container1.off(".fb.touch");
            i(t).off(".fb.touch");
        ...
        r.prototype.ontouchstart = function (r) {
            var f = this
                ...
                , y = c.$content
                , v = "touchstart" == r.type;
            if (v && f.$container1.off("mousedown.fb.touch"),
                    ...
                    ((f.opts || f.canPan) && (o.is(f.$stage) || f.$stage.find(o).length) || (o.is(".fancybox-image") && r.preventDefault(),
                        i.fancybox.isMobile && o.parents(".fancybox-caption").length)) && (f.isScrollable = h(o) || h(o.parent()),
                            ...
                            (1 === f.startPoints.length || c.hasError) && (f.canPan ? (i.fancybox.stop(f.$content),
                                ...
                                f.$container1.addClass("fancybox-is-grabbing")),
                ...
                "x" == s && (t.distanceX > 0 && (t.instance.group.length < 2 || 0 === t.instance.current.index && !t.instance.current.opts.loop) ? u += Math.pow(t.distanceX, .8) : t.distanceX < 0 && (t.instance.group.length < 2 || t.instance.current.index === t.instance.group.length - 1 && !t.instance.current.opts.loop) ? u -= Math.pow(-t.distanceX, .8) : u += t.distanceX),
                    ...
                    t.requestId = o(function () {
                        t.sliderLastPos && (i.each(t.instance.slides, function (n, r) {
                            ...
                            t.$container1.addClass("fancybox-is-sliding"))
                    });
        ...
        r.prototype.ontouchend = function (n) {
            ...
            if (r.endPoints = e(n),
                ...
                r.$container1.removeClass("fancybox-is-grabbing"),
                i(t).off(".fb.touch"),
        ...
        r.prototype.endSwiping = function (n, t) {
            ...
            r.$container1.removeClass("fancybox-is-sliding")
        }
            ;
        ...
        r.prototype.onTap = function (t) {
            ...
            if ((!t.originalEvent || 2 != t.originalEvent.button) && (s.is("img") || !(c > s[0].clientWidth + s.offset().left))) {
                if (s.is(".fancybox-bg,.fancybox-inner,.fancybox-outer,.fancybox-container1"))
                    f = "Outside";
    ...
    function (n, t) {
        ...
        i && (r = {
            ...
            t(n).on(i.fullscreenchange, function () {
                ...
                n && (n.current && "image" === n.current.type && n.isAnimating && (n.isAnimating = !1,
                    ...
                    n.$refs.container1.toggleClass("fancybox-is-fullscreen", i),
        ...
        t(n).on({
            "onInit.fb": function (n, t) {
                ...
                t && t.group[t.currIndex].opts.fullScreen ? (u = t.$refs.container1,
            ...
            "beforeClose.fb": function (n, t) {
                t && t.FullScreen && t.$refs.container1.hasClass("fancybox-is-fullscreen") && r.exit()
            }
        })
    }(document, jQuery),
    function (n, t) {
        ...
        t.extend(r.prototype, {
            ...
            create: function () {
                ...
                n.$grid || (n.$grid = t('<div class="' + i + " " + i + "-" + n.opts.axis + '"><\/div>').appendTo(u.$refs.container1.find(f).addBack().filter(f)),
            ...
            update: function () {
                var n = this;
                n.instance.$refs.container1.toggleClass("fancybox-show-thumbs", this.isVisible);
                ...
                t.fancybox.open({
                    ...
                    opts: {
                        ...
                        afterLoad: function (n, t) {
                            r.$refs.container1.one("beforeClose.fb", function () {
                                n.close(null, 0)
                            });
        ...
        i(function () {
            !1 !== i.fancybox.defaults.hash && (i(t).on({
                ...
                i(n).on("hashchange.fb", function () {
                    var n = r()
                        , t = null;
                    i.each(i(".fancybox-container1").get().reverse(), function (n, r) {
...
sanitizeHTML = function (n) {
    ...
    function (n) {
        ...
        i.defaults = {
            ...
            onSearchError: r,
            preserveInput: !1,
            container1Class: "autocomplete-suggestions",
            tabDisabled: !1,
            dataType: "text",
            currentRequest: null,
        ...
        i.prototype = {
            initialize: function () {
                ...
                t.suggestionsContainer = i.utils.createNode(u.container1Class);
