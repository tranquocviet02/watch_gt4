  ...
  const pe = [function(e) {
      ...
      s({
          pagination: {
              ...
              bulletClass: `${r}-bullet1`,
              bulletActiveClass: `${r}-bullet1-active`,
              modifierClass: `${r}-`,
      ...
      function u() {
          ...
          if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullet1s" === s.type && t.pagination.bullet1s && t.pagination.bullet1s.length > 0) {
              const i = t.pagination.bullet1s;
              let o, d, u;
              if (s.dynamicBullets && (n = x(i[0], t.isHorizontal() ? "width" : "height", !0), p.forEach((e => {
                  ...
                  const i = b(e);
                  i === a ? e.classList.add(...s.bulletActiveClass.split(" ")) : t.isElement && e.setAttribute("part", "bullet"), s.dynamicBullets && (i >= o && i <= d && e.classList.add(...
      ...
      function m() {
          ...
          "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), t.pagination.bullet1s = [], a.forEach((s => {
              "custom" !== e.type && (s.innerHTML = r || ""), "bullet1s" === e.type && t.pagination.bullet1s.push(...s.querySelectorAll(te(e.bulletClass)))
      ...
      function h() {
          ...
          "string" == typeof e.el && t.isElement && (s = t.el.shadowRoot.querySelector(e.el)), s || "string" != typeof e.el || (s = [...document.querySelectorAll(e.el)]), s || (s = e.el), s && 0 !== s.length && (t.params.uniqueNavElements && "string" == typeof e.el && Array.isArray(s) && s.length > 1 && (s = [...t.el.querySelectorAll(e.el)], s.length > 1 && (s = s.filter((e => y(e, ".swiper")[0] === t.el))[0])), Array.isArray(s) && 1 === s.length && (s = s[0]), Object.assign(t.pagination, {
              ...
              "bullet1s" === e.type && e.clickable && s.classList.add(e.clickableClass), s.classList.add(e.modifierClass + e.type), s.classList.add(t.isHorizontal() ? e.horizontalClass : e.verticalClass), "bullet1s" === e.type && e.dynamicBullets && (s.classList.add(`${e.modifierClass}${e.type}-dynamic`), l = 0, e.dynamicMainBullets < 1 && (e.dynamicMainBullets = 1)), "progressbar" === e.type && e.progressbarOpposite && s.classList.add(e.progressbarOppositeClass), e.clickable && s.addEventListener("click", p), t.enabled || s.classList.add(e.lockClass)
          })))
      }
      ...
      function f() {
          ...
          }))), t.pagination.bullet1s && t.pagination.bullet1s.forEach((t => t.classList.remove(...e.bulletActiveClass.split(" "))))
      }
      a("changeDirection", (() => {
      ...
      function f() {
          return t.pagination && t.pagination.bullet1s && t.pagination.bullet1s.length
      }
      ...
      a("beforeInit", (() => {
          ...
          t.params.a11y.enabled && function() {
              const e = t.params.a11y;
              f() && t.pagination.bullet1s.forEach((s => {
